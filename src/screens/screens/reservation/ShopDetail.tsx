...
const ShopDetail = ({ route }: Props) => {
    ...
    const { setFavoriteShop } = useReservation()
                    ...
                    <View style={ styles.priceContainer }>
                            ...
                            <View style={ styles.priceBox }>
                                ...
                                <View style={[ styles.rowContainer, { backgroundColor: '#fff3e9' }]}>
                                    <View style={{ width: '45%', alignItems: 'center', borderRightWidth: 1, borderRightColor: '#cccccc' }}>
                                        <Text style={ styles.priceText }>12시 전</Text>
                                    </View>
                                    <View style={{ width: '55%', alignItems: 'center' }}>
                                        <Text style={ styles.priceText }>12시 이후</Text>
                                    </View>
                                </View>
                            </View>
                            <View style={ styles.priceBox }>
                        ...
                        <View style={[ styles.rowContainer, { borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#cccccc'}]}>
                            ...
                            <View style={[ styles.priceBox, styles.rowContainer ]}>
                                <View style={{ width: '45%', alignItems: 'center', borderRightWidth: 1, borderRightColor: '#cccccc' }}>
                                    <Text style={ styles.priceText }>{ shopInfo.pay.week.h18.before12 ?? '' }</Text>
                                </View>
                                <View style={{ width: '55%', alignItems: 'center' }}>
                                    <Text style={ styles.priceText }>{ shopInfo.pay.week.h18.after12 ?? '' }</Text>
                                </View>
                            </View>
                            <View style={[ styles.priceBox, styles.rowContainer ]}>
                                <View style={{ width: '45%', alignItems: 'center', borderRightWidth: 1, borderRightColor: '#cccccc' }}>
                                    <Text style={ styles.priceText }>{ shopInfo.pay.holiday.h18.before12 ?? '' }</Text>
                                </View>
                                <View style={{ width: '55%', alignItems: 'center' }}>
                                    <Text style={ styles.priceText }>{ shopInfo.pay.holiday.h18.after12 ?? '' }</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[ styles.rowContainer, { borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#cccccc'}]}>
                            ...
                            <View style={[ styles.priceBox, styles.rowContainer ]}>
                                <View style={{ width: '45%', alignItems: 'center', borderRightWidth: 1, borderRightColor: '#cccccc' }}>
                                    <Text style={ styles.priceText }>{ shopInfo.pay.week.h9.before12 ?? '' }</Text>
                                </View>
                                <View style={{ width: '55%', alignItems: 'center' }}>
                                    <Text style={ styles.priceText }>{ shopInfo.pay.week.h9.after12 ?? '' }</Text>
                                </View>
                            </View>
                            <View style={[ styles.priceBox, styles.rowContainer ]}>
                                <View style={{ width: '45%', alignItems: 'center', borderRightWidth: 1, borderRightColor: '#cccccc' }}>
                                    <Text style={ styles.priceText }>{ shopInfo.pay.holiday.h9.before12 ?? '' }</Text>
                                </View>
                                <View style={{ width: '55%', alignItems: 'center' }}>
                                    <Text style={ styles.priceText }>{ shopInfo.pay.holiday.h9.after12 ?? '' }</Text>
                                </View>
                            </View>
                        </View>
                    </View>
